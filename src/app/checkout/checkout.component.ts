...
export class CheckoutComponent implements OnInit {
  ...
  qtyChange(qty,cartObj){
   var request = {
    ...
    this.http.postRequest("cart-service/cart/update-qty-by-cartId/"+cartObj.id+"/"+qty+"/"+(cartObj.price)*(qty)+"",request).subscribe((data:any)=>{
  ...
  getCartDetailsByUser(){
    this.http.postRequest("cart-service/cart/get-cart-by-user-id/{userId}",{}).subscribe((data:any)=>{
      this.cartObj = data;
