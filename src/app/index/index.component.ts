...
export class IndexComponent implements OnInit {
  ...
  ngOnInit() {
    this.http.postRequest("product-service/product/get-all-category",{}).subscribe(data=>{
  ...
  getProductsByCateogy(obj){
   ...
   this.http.postRequestWithToken("product-service/product/get-product-by-category-id/"+obj.id+"",request).subscribe(data=>{
